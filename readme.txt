=== Paid Memberships Pro - ABA PayWay Gateway Add On ===
Contributors: strangerstudios, andrewza, paidmembershipspro
Tags: paid memberships pro, pmpro, payway, gateway, credit card, aba payway, payment in cambodia, 
...
Add the Cambodia payment processing service ABA PayWay as a gateway option for Paid Memberships Pro.
...
1. Upload the `pmpro-payway` directory to the `/wp-content/plugins/` directory of your site.
1. Activate the plugin through the 'Plugins' menu in WordPress.
1. Go to Memberships -> Payment Settings in your WordPress dashboard to complete the ABA PayWay settings.

= Setup =
1. Log in to your WordPress dashboard and navigate to Memberships > Payment Settings.
1. Set your "Payment Gateway" to "ABA PayWay". Fill out your merchant details.
1. Set your currency to "USD Dollars".
